  ...
  return (
    <section id="testimonial" className="py-20 px-4 text-white relative">
          ...
          >
            {testimonials.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="h-[360px] flex flex-col bg-gradient-to-br from-[#1e1e32] to-[#252540] rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-800/50 backdrop-blur-sm">
                  {/* Quote Icon */}
                  ...
                  {/* Testimonial Text */}
                  <div className="flex-grow mb-6 sm:mb-8 overflow-y-auto">
      ...
      <style jsx global>{`
        ...
        /* Optional: customize scrollbar for testimonial text */
        .swiper-slide div.overflow-y-auto::-webkit-scrollbar {
          width: 6px;
        }
        .swiper-slide div.overflow-y-auto::-webkit-scrollbar-thumb {
          background-color: rgba(167, 85, 247, 0.5);
          border-radius: 3px;
        }
      `}</style>
    </section>
